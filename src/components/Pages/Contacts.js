      ...
      <div className="content contacts">
        ...
        <div className="bot">
          <div className="line">
            ...
            <h2>
              <a href="tel:+34642263271">+34 642 263 271</a>, available for:{" "}
            </h2>
            <div>
              ...
              <a href="https://t.me/Konstantin_Modin">
                <img src={telegr} width="85" alt="telegram logo" />
              </a>
              <a href="whatsapp://send?phone=+34642263271">
                <img src={whatsapp} width="85" alt="whatsapp logo" />
              </a>
          ...
          <div className="line">
            <div>
              ...
              <img
                ...
                width="85"
              />
              <img className="email-adress" src={email} alt="email adress" />
            </div>
          </div>
          <div className="line">
            <h3>Links:</h3>
